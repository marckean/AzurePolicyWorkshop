...
CreateAdminUser -PasswordCredential $Credentials -ConfigurationData $ConfigurationData -OutputPath ".\04 Deployment of Guest Config Policies\01 dscConfig_files"
